          ...
          >
            {columnObjects
              ...
              .map((colItem) => (
                <div
                  key={colItem.name}
                  className={`relative flex max-h-[60vh] flex-col rounded-lg border border-gray-700 bg-gray-800 p-2 shadow-md sm:p-4 md:max-h-[90vh]`}
                >
                  ...
                  <div className="overflow-y-auto">
                    {pipelineData[colItem.name]
                      ...
                      .sort(
                        (a, b) => a.tofollowup.seconds - b.tofollowup.seconds,
                      )
                      .map((contact) => (
                        <ContactCard
                          key={contact.id}
